...
import { addActivity } from '../../http/activity'
...
const AddActivity = ({
    ...
    const mutation = useMutation({
        ...
        onSuccess: (data, error, variables, context) => {
            ...
            setAlertNavigate('La Actividad se ha creado correctamente.', 'success', navigate, '/dashboard', 2500)
        },
    ...
    return (
        <section className='container'>
            ...
            <p className='lead'><i className='fas fa-book' /> Crear Actividad</p>
...
export default connect(null, { setAlert, setAlertNavigate })(AddActivity)